...
class CoreLib(Library):
    ...
    def stringFunctions(self):
        self.addFunction('capitalize',String.capitalize)
        self.addFunction('strCount',String.count)
        self.addFunction('encode',String.encode)
        self.addFunction('endswith',String.endswith)
        self.addFunction('find',String.find)
        self.addFunction('index',String.index)
        self.addFunction('isalnum',String.isalnum)
        self.addFunction('isalpha',String.isalpha)
        self.addFunction('isdigit',String.isdigit)
        self.addFunction('islower',String.islower)
        self.addFunction('isspace',String.isspace)
        self.addFunction('istitle',String.istitle)
        self.addFunction('isupper',String.isupper)
        self.addFunction('strJoin',String.join)
        self.addFunction('ljust',String.ljust)
        self.addFunction('lower',String.lower)
        self.addFunction('lstrip',String.lstrip)
        self.addFunction('strPartition',String.partition)
        self.addFunction('replace',String.replace)
        self.addFunction('rfind',String.rfind)
        self.addFunction('rindex',String.rindex)
        self.addFunction('rjust',String.rjust)
        self.addFunction('rpartition',String.rpartition)
        self.addFunction('rsplit',String.rsplit)
        self.addFunction('rstrip',String.lstrip)
        self.addFunction('split',String.split)
        self.addFunction('splitlines',String.splitlines)
        self.addFunction('startswith',String.startswith)
        self.addFunction('strip',String.lstrip)
        self.addFunction('swapcase',String.swapcase)
        self.addFunction('title',String.title)
        # self.addFunction('translate',String.translate)
        self.addFunction('upper',String.upper)
        self.addFunction('zfill',String.zfill)   
    ...
    def datetimeFunctions(self):
        self.addFunction('strftime',Date.strftime)
